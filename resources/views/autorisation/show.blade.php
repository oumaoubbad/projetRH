        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-9">
                         ...
                         <a class="btn btn-info" href="{{ route('autorisations.index') }}"> retour</a>
                         <a class="btn btn-secondary" href="{{ route('autorisations.edit', $autorisation->id) }}"> modifier</i> </a>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
            ...
            <div class="form-group fs-5">
                ...
                {{App\Models\User::findOrFail($autorisation->user_id)->name}}
