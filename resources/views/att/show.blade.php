        ...
        <div class="col-md-10 mx-auto">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-9">
                         ...
                         <a class="btn btn-info" href="{{ route('atts.index') }}"> retour</a>
                         <a class="btn btn-secondary" href="{{ route('att.edit', $att->id) }}"> modifier</i> </a>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
            ...
            <div class="form-group fs-5">
                ...
                {{App\Models\User::findOrFail($att->user_id)->name}}
